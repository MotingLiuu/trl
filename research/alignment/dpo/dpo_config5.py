...
os.environ["WANDB_RUN_NAME"] = "dpo_config5"
os.environ["WANDB_LOG_MODEL"] = "false"

MODEL_PATH = "../model/Qwen3-1.7B-sft-config3/checkpoint-1824"
OUTPUT_DIR = "../model/Qwen3-1.7B-dpo-config5"
...
def main():
    ...
    logger.info(f"configure dpoconfig")
